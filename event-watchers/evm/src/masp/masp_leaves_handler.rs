...
use super::{HttpProvider, MaspContractWrapper};
...
use webb::evm::contract::protocol_solidity::{
    MaspContractEvents, MaspProxyContractEvents,
};
...
/// An Masp Leaves Handler that handles `NewCommitment` events and saves the leaves to the store.
...
pub struct MaspLeavesHandler {
    mt: Arc<Mutex<MerkleTree>>,
    storage: Arc<SledStore>,
}
impl MaspLeavesHandler {
...
impl EventHandler for MaspLeavesHandler {

...
import { Anchor__factory } from '../../build/contracts/types/factories/Anchor__factory';
import { Anchor as AnchorContract} from '../../build/contracts/types/Anchor';
import { rbigint, p256 } from "./utils";
import { toFixedHex, toHex } from './utils';
...
class Anchor {
  ...
  public async deposit(destinationChainId?: number): Promise<AnchorDeposit> {
    ...
    await this.contract.deposit(toFixedHex(deposit.commitment), { gasLimit: '0x5B8D80' });

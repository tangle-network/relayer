...
use webb_proposals::{evm, substrate, TargetSystem, TypedChainId};
...
impl<S> super::ProposalSigningBackend<evm::AnchorUpdateProposal>
...
#[async_trait::async_trait]
impl<S> super::ProposalSigningBackend<substrate::AnchorUpdateProposal>
    for MockedProposalSigningBackend<S>
where
    S: QueueStore<BridgeCommand, Key = SledQueueKey> + Send + Sync + 'static,
{
